        ...
        browser {
            ...
            commonWebpackConfig {
                ...
                devServer = (devServer ?: KotlinWebpackConfig.DevServer()).apply {
                    port = 8081  // Configure the port here
...
android {
    namespace = "com.example.treine_me"
    compileSdk = libs.versions.android.compileSdk.get().toInt()

    defaultConfig {
        applicationId = "com.example.treine_me"
...
compose.desktop {
    application {
        mainClass = "com.example.treine_me.MainKt"

        nativeDistributions {
            targetFormats(TargetFormat.Dmg, TargetFormat.Msi, TargetFormat.Deb)
            packageName = "com.example.treine_me"
